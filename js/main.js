...
!(function($) {
    ...
    $(window).on('load', function() {
      ...
      $('#makan-flters li').on('click', function() {
        $("#makan-flters li").removeClass('filter-active');
        $(this).addClass('filter-active');
  
        makanIsotope.isotope({
    ...
    // makan details carousel
    $(".makan-details-carousel").owlCarousel({
      autoplay: true,
      dots: true,
      loop: true,
      items: 1
